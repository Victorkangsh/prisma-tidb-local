# TiDB & Prisma docker-compose

**For now, the tidb can't run multi shema change, so you have to do DDL one by one**
...
And be sure your Mac have more than 8GB RAM.

## Quick start

```bash
$ git clone https://github.com/victorkangsh/prisma-tidb-local.git
$ cd prisma-tidb-local && docker-compose pull # Get the latest Docker images
$ docker-compose up -d
$ cd #your prisma project root dir
$ prisma deploy
$ #open http://localhost:4466  The prisma playground is running.
```
